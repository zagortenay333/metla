...
// --------------
//
//     istruct (Entry) { UMapHash hash; U64 key; CString val; };
//
//     Bool     cmp    (UMapKey *a, UMapKey *b) { return *cast(U64*, a) == *cast(U64*, b); }
//     UMapHash hasher (UMapKey *k) { return *cast(U64*, k) + 1; }
//
